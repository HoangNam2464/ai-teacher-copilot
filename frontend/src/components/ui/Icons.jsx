...
/**
 * Clean Vector SVG Icons for AI Teacher Copilot UI.
 * Standardized with Phosphor/Lucide-inspired aesthetic, configurable size & color.
 */
...
export function CheckCircle2Icon({ size = 18, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SparklesIcon({ size = 20, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function GraduationCapIcon({ size = 24, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookOpenIcon({ size = 20, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileTextIcon({ size = 20, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SpinnerIcon({ size = 18, className = '', ...props }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`spin-animate ${className}`}
      aria-hidden="true"
      {...props}
    >
...
export function BrainCircuitIcon({ size = 32, className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AppleIcon({ size = 18, className = '', ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.62-.75 1.04-1.8 1.01-2.87-.92.04-2.08.62-2.73 1.37-.58.67-.99 1.74-.86 2.79 1.03.08 2.06-.54 2.58-1.29z" />
    </svg>
  );
}
